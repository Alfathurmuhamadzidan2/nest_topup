    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.products')" :active="request()->routeIs('admin.products')">Produk</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.transactions')" :active="request()->routeIs('admin.transactions')">Transaksi</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.users')" :active="request()->routeIs('admin.users')">Pengguna</x-responsive-nav-link>
            @else
                <x-responsive-nav-link :href="route('user.dashboard')" :active="request()->routeIs('user.dashboard')">Dashboard</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('user.transactions')" :active="request()->routeIs('user.transactions')">Transaksi</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('user.profile')" :active="request()->routeIs('user.profile')">Profil</x-responsive-nav-link>
            @endif
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('user.profile')">Profil</x-responsive-nav-link>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
